 ...
 * 估价师适配器
 */
public class GJSPublishServiceAdapter extends CommonAdapter<GJSPublishServiceModel> {
    private String detailType;

    public GJSPublishServiceAdapter(List<GJSPublishServiceModel> dataList, Context context, int layoutId, String detailType) {
    ...
    public void convert(ViewHolder holder, final GJSPublishServiceModel data) {
        ...
        holder.setOnClickListener(R.id.gjs_avatar, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
