 ...
 * SQLite 读取assets下car_type 数据库文件
 */
...
public class SQLCar {
    ...
    //数据库存储路径
    String filePath = "/data"+Environment.getDataDirectory().getAbsolutePath()+"/com.bhxx.lovecar/cartype.db";
    ...
    public  SQLiteDatabase openDatabase(Context context){
        ...
        if(jhPath.exists()){
            ...
            try {
                ...
                //得到数据库的输入流
                InputStream is=am.open("storage.db");
                //用输出流写到SDcard上面
