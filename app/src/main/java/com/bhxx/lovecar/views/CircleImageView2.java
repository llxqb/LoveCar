...
public class CircleImageView2 extends ImageView {
	...
	public CircleImageView2(Context paramContext) {
		super(paramContext);
	}

	public CircleImageView2(Context paramContext, AttributeSet paramAttributeSet) {
		this(paramContext, paramAttributeSet, 0);
	}

	public CircleImageView2(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
	...
	protected void onDraw(Canvas paramCanvas) {
		...
		/** 保存layer */
		int layer = paramCanvas.saveLayer(0.0F, 0.0F, width, height, null,Canvas.ALL_SAVE_FLAG);//31
		/** 设置drawable的大小 */
